package mn.univision.secretroom.presentation.screens.layout
...
import mn.univision.secretroom.presentation.common.Navbar
import mn.univision.secretroom.presentation.common.TopBarTabs
import mn.univision.secretroom.presentation.common.TopbarFocusRequesters
import mn.univision.secretroom.presentation.screens.Screens
import mn.univision.secretroom.presentation.screens.actors.ActorsScreen
import mn.univision.secretroom.presentation.screens.bandles.BandlesScreen
import mn.univision.secretroom.presentation.screens.commerce.CommerceScreen
...
import mn.univision.secretroom.presentation.screens.settings.SettingsScreen
...
fun rememberChildPadding(direction: LayoutDirection = LocalLayoutDirection.current): Padding {
    return remember {
        Padding(
            start = ParentPadding.calculateStartPadding(
                direction
            ) + 8.dp,
            top = ParentPadding.calculateTopPadding(),
            end = ParentPadding.calculateEndPadding(
                direction
            ) + 8.dp,
